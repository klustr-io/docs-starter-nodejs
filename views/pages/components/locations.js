...
const recordLocation = (callback) => {
  getDeviceLocation((position) => {
    ...
    axios
      .post(
        "https://gateway.dev.klustr.io/events/locations",
        {
...
const getMostRecentLocation = function (json) {
  ...
  return axios.get("https://gateway.dev.klustr.io/events/locations", {
    headers: {
...
const deleteLocations = function (json) {
  ...
  return axios.delete("https://gateway.dev.klustr.io/events/locations", {
    headers: {
      Authorization: "Bearer " + accessToken,
      "X-API-Key": getApiKey(),
    },
